    ...
    return (
      <Html lang="en" dir="ltr">
        <Head>
          ...
          {/* Icons*/}
          <link rel="apple-touch-icon" sizes="180x180" href={`${process.env.SITE_URL}/icons/apple-touch-icon.png`} />
          <link rel="icon" type="image/png" sizes="32x32" href={`${process.env.SITE_URL}/icons/favicon-32x32.png`} />
          <link rel="icon" type="image/png" sizes="16x16" href={`${process.env.SITE_URL}/icons/favicon-16x16.png`} />
          <link rel="manifest" href={`${process.env.SITE_URL}/icons/site.webmanifest`} />
          <link rel="mask-icon" href={`${process.env.SITE_URL}/icons/safari-pinned-tab.svg`} color="#f45d22" />
          <link rel="shortcut icon" href={`${process.env.SITE_URL}/icons/favicon.ico`} />
          <meta name="msapplication-TileColor" content="#da532c" />
          <meta name="msapplication-config" content={`${process.env.SITE_URL}/icons/browserconfig.xml`} />
